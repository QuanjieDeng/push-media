...
config.nuve.superserviceID = '5dbf9cd3334ccd197d9f9ad7'; // default value: ''
config.nuve.superserviceKey = '512'; // default value: ''
...
// config.erizoController.iceServers = [{'url': 'turn:192.168.94.21:3478','username':'demo','credential':'123456'}]; // default value: [{'url': 'stun:stun.l.google.com:19302'}]
...
config.erizo.useConnectionQualityCheck = false; // default value: false
